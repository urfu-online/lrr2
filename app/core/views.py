...
def passport(request, passport_id):
    ...
    return render(request, 'passport.html', {
        'breadcrumbs': [
                ...
                {'name': 'ЭУК' + ' ' + '"Основы проектирования интерфейсов"', 'url': '', 'active': False},
        ...
        'passport': {
            ...
            'stamp_subjects': [
                {'subject': 'Основы проектирования интерфейсов', 'direction': 'Программная инженерия', 'percentage': '100%'},
                {'subject': 'Проектирование человеко-машинных интерфейсов', 'direction': 'Прикладная информатика', 'percentage': '100%'}
            ],
...
def myresources(request):
    ...
    return render(request, 'myresources.html', {
        'breadcrumbs': [
